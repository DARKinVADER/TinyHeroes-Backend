...
| L-G2 | ✅ | "Forgot password?" link navigates to /forgot-password — covered as FP-09 in `frontend/e2e/forgot-password.spec.ts` |
...
Feature: Add Child
  ...
  Scenario: AC-05 Can select Boy/Girl gender
    ...
    Then the "Girl" button has the bg-brand-orange class
